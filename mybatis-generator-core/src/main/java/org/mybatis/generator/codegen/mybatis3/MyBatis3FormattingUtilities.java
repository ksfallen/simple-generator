...
public class MyBatis3FormattingUtilities {
    ...
    public static String getParameterClauseWithoutJdbcType(
            IntrospectedColumn introspectedColumn) {
        StringBuilder sb = new StringBuilder();
     ...
     * @return
     */
    public static String getParameterIn(IntrospectedColumn column) {
        StringBuilder sb = new StringBuilder();
        sb.append("#{item");
    ...
    public static String getParameterForEach(IntrospectedColumn column) {
        StringBuilder sb = new StringBuilder();
        sb.append("#{item.");
