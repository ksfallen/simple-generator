...
import static org.mybatis.generator.internal.util.HashCodeUtil.*;
...
public class FullyQualifiedTable {
    ...
    public String getDomainObjectName() {
        ...
        finalDomainObjectName = stringHasValue(runtimeTableName) ? runtimeTableName : introspectedTableName;
        ...
        finalDomainObjectName =  getCamelCaseString(finalDomainObjectName, true);
